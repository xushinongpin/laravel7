...
return [
    ...
    */
    ...
    'gt'                   => [
        ...
        "string" => "：属性必须大于：value字符。",
        "array" => "：属性必须包含多个：值项。",
    ],
    'gte'                  => [
        "numeric" => "：属性必须大于或等于：value。",
        "file" => "：属性必须大于或等于：value kilobytes。",
    ...
    "mimes" => "：属性必须是类型为:: values的文件。",
    "mimetypes" => "：属性必须是类型为:: values的文件。",
    'min'                  => [
        "numeric" => "：属性必须至少为：min。",
        "file" => "：属性必须至少为：min kilobytes。",
    ...
    "required_without" => "在：values不存在时，：attribute字段是必需的。",
    "required_without_all" => "当没有：values存在时，：attribute字段是必需的。",
    "same" => "：属性和：其他必须匹配。",
    'size'                 => [
        "numeric" => "：属性必须是：size。",
        "file" => "：属性必须是：size kilobytes。",
        "string" => "：属性必须是：大小字符。",
        "array" => "：属性必须包含：大小项。",
    ],
    "string" => "：属性必须是字符串。",
